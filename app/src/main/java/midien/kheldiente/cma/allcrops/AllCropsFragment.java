...
import midien.kheldiente.cma.BuildConfig;
import midien.kheldiente.cma.R;
import midien.kheldiente.cma.allcrops.adapter.CropAdapter;
...
public class AllCropsFragment extends Fragment
    ...
    public void displayCrops(List<Crop> crops) {
        ...
        cropAdapter.setBaseUrlForImage(BuildConfig.BASE_IMG_URL);
